...
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-xl border p-6 pr-8 shadow-2xl transition-all',
  {
    variants: {
      variant: {
        default: 'border-slate-700/50 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl text-white',
        destructive: 'border-red-500/50 bg-gradient-to-br from-red-900/90 to-red-800/90 backdrop-blur-xl text-red-100 group',
      },
    },
    defaultVariants: {
      variant: 'default',
